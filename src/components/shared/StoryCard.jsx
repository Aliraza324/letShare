    ...
    <article className="relative h-[72px] overflow-hidden rounded-[8px] bg-white sm:aspect-[0.9] sm:h-auto sm:min-h-[190px] sm:rounded-xl">
      ...
      {story.avatar && (
        <img
          src={story.avatar}
          alt=""
          className="absolute left-1 top-1 h-5 w-5 rounded-full border-2 border-[#8ddf00] object-cover shadow-[0_6px_12px_rgba(15,23,42,0.22)] sm:left-2 sm:top-2 sm:h-9 sm:w-9"
        />
      )}
    </article>
  )
